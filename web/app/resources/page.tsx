      ...
      <section className="px-5 pb-28 md:px-8">
        <div className="mx-auto grid max-w-[1320px] gap-10 lg:grid-cols-2">
          {courseTracks.map((track) => {
            ...
            return (
              <article key={track.id} className={`rounded-[2rem] border border-border bg-surface p-6 md:p-9 ${orange ? "shadow-[11px_13px_0_rgba(242,106,46,0.24)]" : "shadow-[11px_13px_0_rgba(36,87,214,0.76)]"}`}>
